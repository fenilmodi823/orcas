...
async function createSingleThreadRuntime() {
	const { default: createWasmModuleSingleThread } = await import("./base-release-rcXjXIb1.js");
...
async function createMultiThreadRuntime(options) {
	const { default: createWasmModuleMultiThread } = await import("./pthreads-release-BFJ17FWe.js");
